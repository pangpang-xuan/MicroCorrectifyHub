...
namespace RecALLDemo.Contrib.MaskedTextItem.Api.Services;

public class MaskedTextItemContext : DbContext
{
    public DbSet<Models.MaskedTextItem> MaskedTextItems { get; set; }   //controller 有相应的使用
...
public class MaskedTextItemConfiguration : IEntityTypeConfiguration<Models.MaskedTextItem>
{
    public void Configure(EntityTypeBuilder<Models.MaskedTextItem> builder)
    {
        ...
        builder.Property(p => p.MaskedContent).IsRequired();  // new
...
public class 
    MaskedTextListContextDesignFactory : IDesignTimeDbContextFactory<MaskedTextItemContext>
{
