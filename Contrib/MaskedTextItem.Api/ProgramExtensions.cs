...
using Polly;
using RecALLDemo.Contrib.MaskedTextItem.Api.Filters;
...
public static class ProgramExtensions {
    ...
    public static void UseCustomSwagger(this WebApplication app) {
        ...
        app.UseSwaggerUI(options => {
            options.OAuthClientId("MaskedTextListApiSwaggerUI");
            options.OAuthAppName("MaskedTextListApiSwaggerUI");
        });
    }
    ...
    public static void AddCustomDatabase(this WebApplicationBuilder builder) {
        builder.Services.AddDbContext<MaskedTextItemContext>(p =>
            p.UseSqlServer(
                builder.Configuration["ConnectionStrings:MaskedTextItemContext"]));
    }
    ...
    public static void AddCustomIdentityService(
        ...
        builder.Services.AddAuthentication(options => {
            ...
            options.Audience = "MaskedTextList";
        });
    }
    ...
    public static void ApplyDatabaseMigration(this WebApplication app) {
        ...
        var context =
            scope.ServiceProvider.GetRequiredService<MaskedTextItemContext>();
